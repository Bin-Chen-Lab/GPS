...
cpd_sele = pd.read_csv('./data_for_code/cmpd_profile_robustness/selected_multiCell_cmpds-1.csv', index_col='StructID')
...
plt.tight_layout()
#plt.savefig('./data_for_code/umap_cmpd_profile_robustness.pdf', transparent=True)
