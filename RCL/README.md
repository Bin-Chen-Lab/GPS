...
[Here](https://s3.amazonaws.com/chenlab-data-public/GPS4Drugs_RCL/LINCS_NEW_LOW_DOSE_L4.csv) is the raw data downloaded from LINCS L4 for drug-induced gene expression in various cell lines under the lose-dose condition. 
